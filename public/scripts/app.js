...
var Person = function () {
  ...
  function Person() {
    var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "Annoymous";
...
var Student = function (_Person) {
  ...
  _createClass(Student, [{
    ...
    value: function getDescription() {
      ...
      if (this.hasMajor()) return description + " " + this.name + " is majoring in " + this.major;else return description;
    }
  }]);
...
var Traveller = function (_Person2) {
  ...
  _createClass(Traveller, [{
    ...
    value: function getGreeting() {
      ...
      if (this.hasHomeLocation(0)) return greeting + " I'm visiting from " + this.homeLocation;else return greeting;
    }
  }]);
...
var me = new Traveller("Sanuja Cooray", 26, "Colombo");
